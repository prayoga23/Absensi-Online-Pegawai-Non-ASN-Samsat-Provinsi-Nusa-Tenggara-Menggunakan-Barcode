				...
				<div class="content-top-grids">
					...
					<div class="col-md-4 contact-right">
						...
						<div class="contact-right-middle">
							...
							<div class="login-info">
								...
								<a href="index" class="btn btn-primary btn-lg btn-block" type="submit">Kembali ke Home</a>
							...
							<div class="col-md-6 user-grid">
								<div class="user-grid-info">
									...
									<p class="wow fadeInRight animated" data-wow-delay=".5s"><?php
																								...
																								echo $t_pulang; ?> <sup><?= number_format($t_pulang / $t_karyawan * 100, 0); ?> %</sup></p>
									<!-- <div class="progress">
					...
					<div class="col-md-4 content-right">
						<div class="clock-grids wow fadeInRight animated" data-wow-delay=".5s">
							<div id="verticalTab" class="resp-vtabs" style="display: block; width: 100%; margin: 20px; padding-bottom: 100px">
								<!-- start vertical Tabs-->

								<div class="resp-tabs-container">
									<h2 class="resp-accordion resp-tab-active" role="tab" aria-controls="tab_item-0"><span class="resp-arrow"></span><i class="icon_1"></i> </h2>
