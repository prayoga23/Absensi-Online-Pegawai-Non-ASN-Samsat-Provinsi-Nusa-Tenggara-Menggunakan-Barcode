			...
			<div class="body">
				<div class="table-responsive">
					<table class="table table-bordered table-striped table-hover dataTable js-exportable">
						...
						<tbody>
							<?php
							$s_absen = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM absensi,karyawan where absensi.nik=karyawan.nik AND tanggal between '$_GET[start_date]' AND '$_GET[end_date]' AND karyawan.divisi LIKE '%$_GET[divisi]'");
							...
							?>
								<tr>
									...
									<td><?= $d_absen['nik']; ?></td>
									<td><?= $d_absen['nama']; ?></td>
									<td><?php $a = $d_absen['divisi'];
										$d_a = mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * from divisi where kode_divisi ='$a'"));
										echo $d_a['divisi']; ?></td>
									...
									<td><?php $hourdiff  = round((strtotime($d_absen['pulang']) - strtotime($d_absen['masuk'])) / 3600, 1);
										if ($hourdiff > 8) { ?>
											<font style="color:green"><?= $hourdiff; ?></font>
										<?php } else if ($hourdiff < 8) { ?>
											<font style="color:red"><?= $hourdiff; ?> </font>
										<?php
										} ?>
									</td>
									<td>
	...
	<div class="modal-dialog modal-sm" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form name="myForm" id="myForm" action="controller/absensi_edit.php?&divisi=<?= $_GET['divisi']; ?>" method="post" enctype="multipart/form-data">
					<div class="row clearfix">
