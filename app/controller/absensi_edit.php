...
$proses = mysqli_query($GLOBALS["___mysqli_ston"], $s_p);
	if ($proses) {
		...
		header('location:../absensi?start_date='.$_GET[start_date].'&end_date='.$_GET[end_date].'&divisi='.$_GET[divisi].'&sukses='.base64_encode('data absen NIK '.$nik.', tanggal '.$tanggal.' telah diedit, Terimakasih'));
